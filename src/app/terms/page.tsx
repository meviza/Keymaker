...
const sections = [
  {
    ...
    body: "Site içeriği bilgilendirme amaçlıdır. Ürün kapsamı; sözleşme, teklif ve teknik keşif sonucunda netleşir.",
  },
  {
    icon: Scale,
    title: "Kullanım Koşulları",
    body: "Keymaker platformu, etik sınırlar, yetki kapsamı ve kurumsal politikalara tabi şekilde kullanılmak üzere tasarlanır.",
  },
  {
    icon: AlertTriangle,
    title: "Yasaklı Kullanım",
    body: "Yetkisiz kullanım, tersine mühendislik veya kötüye kullanıma yönelik girişimler desteklenmez ve hizmete erişim kısıtlanabilir.",
  },
  {
    icon: CheckCircle2,
    title: "Sorumluluk Sınırı",
    body: "Keymaker, bilgilendirme amaçlı yayımlanan içeriklerden doğan dolaylı zararlardan sorumlu tutulamaz. Detaylar sözleşme aşamasında belirlenir.",
  },
];
